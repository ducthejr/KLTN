<?php
	...
	$sql = "SELECT * FROM table_pigdata_mysql where id = ?";
	$q = $pdo->prepare($sql);
	$q->execute(array($id));
	...
	<body>
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					<h3 align="center">Edit Pig Data</h3>
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="giong" type="text"  placeholder="" value="<?php echo $data['giong'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="gioitinh" id="mySelect">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="ngaytuoi" type="text" placeholder="" value="<?php echo $data['ngaytuoi'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="cannang" type="text"  placeholder="" value="<?php echo $data['cannang'];?>" required>
						</div>
					</div>
