...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="user data.php">Pig Data</a></li>
            ...
            <div class="row">
                <table class="table table-striped table-bordered">
                  ...
                  <?php
                   ...
                   $sql = 'SELECT * FROM table_pigdata_mysql ORDER BY giong ASC';
                   foreach ($pdo->query($sql) as $row) {
                            echo '<tr>';
                            echo '<td>'. $row['giong'] . '</td>';
                            echo '<td>'. $row['id'] . '</td>';
                            echo '<td>'. $row['gioitinh'] . '</td>';
							echo '<td>'. $row['ngaytuoi'] . '</td>';
